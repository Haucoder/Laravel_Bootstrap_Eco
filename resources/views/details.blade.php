      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          @if(Cart::instance('cart')->content()->where('id',$product->id)->count()>0)
             <a href="{{route('cart.index')}}" class="btn btn-light">View Cart</a>
           @else
          ...
          <div class="product-single__addtolinks">
            ...
            <form action="{{route('wishlist.remove_item',['rowId'=>Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId])}}" method="post" id="remove-item-from-details"> 
                      @csrf
                      @method('DELETE')
            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('remove-item-from-details').submit()"><svg width="16" height="16" viewBox="0 0 20 20"
        ...
        <div class="swiper-wrapper">
                @foreach ( $rproducts as $rproduct ) 
                        ...
                        <div class="pc__img-wrapper">
                            ...
                            {{-- SỬA Ở ĐÂY: Dùng $rproduct->images VÀ SỬA LỖI CÚ PHÁP HTML --}}
                            @if (!empty($rproduct->images))
                                @foreach ( explode(',', $rproduct->images) as $gimg )
                                @if (trim($gimg))
                                    <img loading="lazy" src="{{ asset('upload/products/'. trim($gimg)) }}" width="330" height="400"
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <span class="money price">
                                {{-- SỬA TOÀN BỘ KHỐI GIÁ NÀY: Dùng $rproduct --}}
