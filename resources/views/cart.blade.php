      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
          <table class="cart-table">
            ...
            <tbody>
                              {{-- Vòng lặp dùng $items (số nhiều) --}}
                @foreach($items as $item)
                <tr>
                    <td>
                        <div class="shopping-cart__product-item">
                            {{-- BÊN TRONG phải dùng $item (số ít) --}}
                    ...
                    <td>
                        <div class="qty-control position-relative">
                            {{-- SỬA Ở ĐÂY: Lấy số lượng thực tế --}}
                            <input type="number" name="quantity" value="{{$item->qty}}" min="1" class="qty-control__number text-center">

                            <form action="{{route('cart.decrease_quantity', $item->rowId)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="qty-control__reduce">-</div>
                            </form>

                            <form method="post" action="{{route('cart.increase_quantity', $item->rowId)}}">
                                @csrf
                                @method('PUT')
                    ...
                    <td>
                        <form action="{{route('cart.remove_item', $item->rowId)}} " method="post">
                            @csrf
                            @method('DELETE')
